...
group = 'sequence' #'fold' #'sequence'#'cell_line' #"Chromosome" #"symbol", "log2fc"
...
# output
y = ['class'] # ["Normalized efficacy"] #'log2fc'
y_transform = False
...
training = True
old_model_hdf5_path = os.path.join(cur_dir, "dataset/AGG4/history_10_17/run_AGG4__CN_centrality_reg_mix1810142307")
...
retransform = False
run_specific_data_after_transform = os.path.join(data_dir, "after_transform_data_deepCrispr")
